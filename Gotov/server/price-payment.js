...
app.post('diplomen-production.up.railway.app/reserve', async (req, res) => {
...
app.get('diplomen-production.up.railway.app/get-reserved-times', (req, res) => {
    res.status(200).json(reservedTimes);
});


// Създаване на Stripe PaymentIntent
app.post('diplomen-production.up.railway.app/create-payment-intent', async (req, res) => {
...
app.post('diplomen-production.up.railway.app/verify-hcaptcha', async (req, res) => {
...
app.post('diplomen-production.up.railway.app/subscribe', async (req, res) => {
